...
public interface BooksWebService {
    ...
    @Action(input = "http://soap.com/BooksWebService/createBooksRequest", output = "http://soap.com/BooksWebService/createBooksResponse")
    ...
    @Action(input = "http://soap.com/BooksWebService/deleteBooksRequest", output = "http://soap.com/BooksWebService/deleteBooksResponse")
    ...
    @Action(input = "http://soap.com/BooksWebService/updateBooksRequest", output = "http://soap.com/BooksWebService/updateBooksResponse")
